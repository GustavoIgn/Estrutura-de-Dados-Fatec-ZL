...
public class PlayerController {
    ...
    public void adicionarMusica(ListaSet<Musica> lista, String musica) {
    ...
    public void removerMusica(ListaSet<Musica> lista, int posicao) {
        try {
    ...
    public void executarPlaylist(ListaSet<Musica> lista) {
        int i = 0;
